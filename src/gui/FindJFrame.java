 ...
 * @author lab026
 */
public class FindJFrame extends javax.swing.JDialog {

    /**
     * Creates new form FindDialog
     */
    public FindJFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Find");
    ...
    private void jButtonFindNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFindNextActionPerformed
        ...
        ((Notepad) this.getParent()).setFindDown(jRadioButtonDown.isSelected());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FindJFrame dialog = new FindJFrame(new javax.swing.JFrame(), true);
