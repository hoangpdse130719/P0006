 ...
 * @author lab026
 */
public class ReplaceJFrame extends javax.swing.JDialog {

    /**
     * Creates new form ReplaceDialog
     */
    public ReplaceJFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Replace");
        jTextFieldFind.setText(((Notepad) this.getParent()).getFindStr());
    }
    ...
    private void jButtonFindNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFindNextActionPerformed
        ...
        ((Notepad) this.getParent()).setFindStr(jTextFieldFind.getText());
        ((Notepad) this.getParent()).FindText();
    ...
    private void jButtonReplaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReplaceActionPerformed
        // TODO add your handling code here:
        ((Notepad) this.getParent()).setFindDown(true);
        ((Notepad) this.getParent()).setFindStr(jTextFieldFind.getText());
        ((Notepad) this.getParent()).ReplaceText(jTextFieldReplace.getText());
    ...
    private void jButtonReplaceAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReplaceAllActionPerformed
        // TODO add your handling code here:
        ((Notepad) this.getParent()).setFindStr(jTextFieldFind.getText());
        ((Notepad) this.getParent()).ReplaceAll(jTextFieldReplace.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReplaceJFrame dialog = new ReplaceJFrame(new javax.swing.JFrame(), true);
