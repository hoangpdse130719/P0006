 ...
 * @author lab026
 */
public class FontJFrame extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FontJFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Font");
        AddListFont();
    ...
    public void setPreviewText() {
        Font f = ((Notepad) this.getParent()).getjTextAreaNote().getFont();
        lbPreview.setFont(f);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FontJFrame dialog = new FontJFrame(new javax.swing.JFrame(), true);
